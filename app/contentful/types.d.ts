import { Asset, RichTextContent, EntrySkeletonType } from "contentful";
...
export interface ContentfulMicroblog extends EntrySkeletonType{
  microblogTitle: string;
  microblogSlug: string;
  microblogBody: RichTextContent;
}
